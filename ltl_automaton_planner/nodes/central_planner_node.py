...
class Central_Planner(object):
    ...
    def setup_pub_sub(self):
        ...
        self.plan_pub_2 = rospy.Publisher('/a1_gazebo/global_planner/action_plan', LTLStateArray, latch=True,
                                          queue_size=1)
        self.plan_pub_3 = rospy.Publisher('/wassi_0/global_planner/action_plan', LTLStateArray, latch=True,
                                          queue_size=1)
        ...
        self.replan_sub_1 = rospy.Subscriber('/dr_0/global_replanning_request', GlobalReplanInfo,
                                             self.ltl_replan_callback_1, queue_size=1)
        self.replan_sub_2 = rospy.Subscriber('/a1_gazebo/global_replanning_request', GlobalReplanInfo,
                                             self.ltl_replan_callback_2, queue_size=1)
        self.replan_sub_3 = rospy.Subscriber('/wassi_0/global_replanning_request', GlobalReplanInfo,
